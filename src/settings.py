...
ALLOWED_HOSTS = ['0.0.0.0', 'localhost','127.0.0.1','192.168.1.123']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'clinic.context_processors.staff_context',  # Add this line
            ],
        },
    },
]
...
STATIC_URL = 'static/'
STATIC_ROOT = BASE_DIR / 'staticfiles'  # Define where collected static files will be stored
STATICFILES_DIRS = [
